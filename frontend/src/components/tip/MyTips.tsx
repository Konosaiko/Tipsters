  ...
  if (isLoading) {
    return (
      <div className="bg-white shadow sm:rounded-lg p-6">
        <p className="className="text-neutral-500 text-center">Loading your tips...</p>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white shadow sm:rounded-lg">
      <div className="px-4 py-5 sm:p-6">
        <h3 className="className="text-lg leading-6 font-medium text-neutral-900 mb-4">My Published Tips</h3>

        {tips.length === 0 ? (
          <p className="className="text-neutral-500 text-center py-8">
