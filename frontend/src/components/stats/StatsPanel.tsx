  ...
  return (
    <div className="bg-white rounded-lg border border-neutral-200 p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-lg font-bold text-neutral-900">Performance Stats</h3>
      ...
      <div className="border-t border-neutral-200 pt-4">
        <h4 className="text-sm font-semibold text-neutral-700 mb-3">Detailed Breakdown</h4>

        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
          <div>
            <p className="text-neutral-600">Total Tips</p>
            <p className="text-lg font-semibold text-neutral-900">{stats.totalTips}</p>
          </div>
          <div>
            <p className="text-neutral-600">Settled</p>
            <p className="text-lg font-semibold text-neutral-900">{stats.settledTips}</p>
          </div>
          <div>
            <p className="text-neutral-600">Pending</p>
            <p className="text-lg font-semibold text-neutral-900">{stats.pendingTips}</p>
          </div>
          <div>
            <p className="text-neutral-600">Avg Odds</p>
            <p className="text-lg font-semibold text-neutral-900">{(stats.averageOdds ?? 0).toFixed(2)}</p>
          </div>
        </div>
          ...
          <div className="mt-4 pt-4 border-t border-neutral-200">
            <div className="grid grid-cols-2 gap-4 text-sm">
              {stats.longestWinStreak > 0 && (
                <div>
                  <p className="text-neutral-600">Longest Win Streak</p>
              ...
              {stats.longestLoseStreak > 0 && (
                <div>
                  <p className="text-neutral-600">Longest Lose Streak</p>
