  ...
  return (
    <div className="bg-neutral-900 rounded-lg border border-neutral-800 p-6">
      ...
      <div className="border-t border-neutral-800 pt-4">
        <h4 className="text-sm font-semibold text-neutral-300 mb-3">Detailed Breakdown</h4>

        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
          <div>
            <p className="text-neutral-400">Total Tips</p>
            <p className="text-lg font-semibold text-white">{stats.totalTips}</p>
          </div>
          <div>
            <p className="text-neutral-400">Settled</p>
          ...
          <div>
            <p className="text-neutral-400">Avg Odds</p>
          ...
          <div className="mt-4 pt-4 border-t border-neutral-800">
            <div className="grid grid-cols-2 gap-4 text-sm">
              {stats.longestWinStreak > 0 && (
                <div>
                  <p className="text-neutral-400">Longest Win Streak</p>
              ...
              {stats.longestLoseStreak > 0 && (
                <div>
                  <p className="text-neutral-400">Longest Lose Streak</p>
